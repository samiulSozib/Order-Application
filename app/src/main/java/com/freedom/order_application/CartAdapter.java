...
class CartViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener, View.OnCreateContextMenuListener {
    ...
    public TextView text_cart_name,text_price,item_type,free;
    ...
    public CartViewHolder(@NonNull View itemView) {
        ...
        item_type=itemView.findViewById(R.id.cart_item_type);
        free=itemView.findViewById(R.id.cart_item_free);
...
public class CartAdapter extends RecyclerView.Adapter<CartViewHolder>{
    ...
    public void onBindViewHolder(@NonNull CartViewHolder holder, int position) {
        ...
        holder.item_type.setText(listData.get(position).getQntType());
        holder.free.setText("Free : "+listData.get(position).getFree());
    }
